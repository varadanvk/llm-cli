...
#             # if stream:
#             #     return (delta for delta in response.text_stream)  # Generator yielding deltas
#             # return "".join(response.text_stream)  # Aggregate full response if not streaming
...
#                 model=model
#             ) as stream:
#                 return (delta for delta in stream.text_stream)  # Generator yielding deltas
